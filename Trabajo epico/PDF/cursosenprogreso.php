...
$stmt = $pdo->prepare('SELECT * FROM cursos WHERE fecha_fin_insc <= CURRENT_DATE() AND fecha_ini <=CURRENT_DATE() AND fecha_fin >=CURRENT_DATE() ORDER BY  fecha_fin_insc ASC');
$stmt->execute();
